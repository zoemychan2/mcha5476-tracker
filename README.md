...
----------
# Iteration 1: Input Feedback, Input prompt and reset button
...
By putting placeholder text, it prompts the users to know what they need to fill out immediately - as users tend to scan through forms quickly (Learning Loop, 2023).  

*Before iteration - Input Feedback, Input prompt and reset button*
![image 4](readmeimage/image4.png)
![image 5](readmeimage/image5.png)



*After iteration - Input Feedback, Input prompt and reset button*
...
I used Futura as my font for my web app prototype. Although this font was similar with the previous 'Lexend' font used in the web app design as they both use sans serifs, I felt that Futura was more bolded and more readable. Especially with the thin lines in the background image, I felt that the bolded letter help to stand out and contrast more, improving visible accessibility. To keep my web app look cohesive, I made sure only Futura was used to make it look more consistent. To distinguish the headings and the body text, bolded and size typography were used to create hierarchy within the web app (Interaction Design Foundation, N.a.).
...
*Old datedelete section & list section* 
![image 16](readmeimage/image16.png)


*New datedelete section & list section with cute icon images* 
